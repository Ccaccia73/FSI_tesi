...
\vspace{15mm}
% Titolo Tesi
\huge{\textbf{Fluid-Structure Interaction based on co-simulation with Multibody Dynamics}} \\
\vspace{35mm}
\end{center}
...
\small{\textbf{Prof. Pierangelo MASARATI}} \\
\vspace{5mm}
\normalsize{Co-Supervisor} \\
\small{\textbf{Prof. Marco MORANDINI}} \\
\end{flushleft}
\vspace{15mm}
